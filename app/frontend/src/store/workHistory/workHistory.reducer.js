...
export const workHistoryReducer = (state = initialState, {
  type,
  activeStepIndex
}) => {
  switch (type) {
    case SET_ACTIVE_STEP:
      return {
        ...state,
        ...{
          activeStepIndex: state.activeStepIndex === activeStepIndex ? null : activeStepIndex
        }
      };
    ...
    case GO_TO_PREVIOUS_STEP:
      return {
        ...state,
        ...{
          activeStepIndex: state.activeStepIndex - 1 < 0 ? 0 : state.activeStepIndex - 1
        }
      };
